...
<?php
    ...
    $sql = "SELECT * FROM `mini_pis_details` WHERE `FATHER_NAME` = '$fathersName'";
...
<head>
    ...
    <body>
    <form method="post" action="fathersName.php">
        Enter employee Title:<input type="text" name="fathersName" value="fathersName">
