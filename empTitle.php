...
<?php
    ...
    $sql = "SELECT * FROM `mini_pis_details` WHERE `EMP_TITLE` = '$empTitle'";
...
<head>
    ...
    <body>
    <form method="post" action="empTitle.php">
        Enter employee Title:<input type="text" name="empTitle" value="empTitle">
